    ...
    if ((e.key === " " || e.code === "Space" || e.keyCode === 32) && canProgress) {
        ...
        switch (dialogueStep) {
            case 1:
                ...
                $("#textContent").text("Alright, I've organized our research into an essay, condensed into five folders. Let's take a look at what we've found! (click on folders to open them) (click on space TWICE when done)");
                break;
            case 2:
                break;
            case 3:
